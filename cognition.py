...
class Face_Recognizer:
    ...
    def csv_writer(self):
        with open("data/detector_data.csv", "a+") as csvfile:
    ...
    def draw_name_and_emotion(self, img_rd):
        ...
        for i in range(self.current_frame_face_cnt):
            ...
            draw.text(xy=self.current_frame_emotion_position_list[i], text=self.current_frame_emotion_list[i], font=font)
                ...
                if kk == ord('q'):
                    ...
                    if len(faces) != 0:
                        ...
                        for k in range(len(faces)):
                            ...
                            # emotion process
                            roi_gray = gray_frame[faces[k].top(): faces[k].bottom(), faces[k].left() : faces[k].right()]
                            ...
                            self.current_frame_emotion_list.append(predicted_emotion)
